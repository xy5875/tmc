...
main_folder = "/home/dell/xy/new/mobicom-TWT/cifar/train_data_0.01"
labels_set = set()
for i in range(10):
    labels_set.clear()
    print("i is ",i)
    X_train, y_train, X_test, y_test, net_dataidx_map, traindata_cls_counts = partition_data(
        "cifar10", "/home/dell/xy/new/mobicom-TWT/cifar/data", "./logs/", "noniid", 10, beta=0.01)
    dataidxs = net_dataidx_map[i]    
    train_dl_local, test_dl_local, _, _ = get_dataloader('cifar10',"/home/dell/xy/new/mobicom-TWT/cifar/data", 1, 1, dataidxs)
    id_folder = os.path.join(main_folder, str(i))
    os.makedirs(id_folder, exist_ok=True)
    
# 假设train_dataloader是一个包含图片和标签的列表
    for image, label in train_dl_local:
        # 将标签加入集合
