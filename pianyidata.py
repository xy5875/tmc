...
# 下载CIFAR-10数据集
train_dataset = datasets.CIFAR10(root='/home/dell/xy/AFLvsGFL/data/cifar', train=True, download=False, transform=transform)

# 定义存储图像的主文件夹
base_folder = "/home/dell/xy/Fisher/data/C"
