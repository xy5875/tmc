...
python start_client.py --anchor False --port 8081 --mask False  --delay False --dataroot /home/dell/xy/new/mobicom-TWT/cifar/train_data_0.2 --testfile /home/dell/xy/AFLvsGFL/data/test_avg/0
